...
module.exports = {
    /**
     * This method loads static files, and changes some constants in them depending on the route
     * It's a modified version of express.static middleware
     */
    editStatic: function (root, routes, options) {
        if (!root) {
        ...
        return function serveStatic(req, res, next) {
            ...
            res.write = function (chunk, encoding) {
                const excludes = [".ico", ".json", ".png", ".js", ".css"];
